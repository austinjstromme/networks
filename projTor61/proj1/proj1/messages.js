...
// returned result will depend on what message is received.
exports.processMessage = function(message) {
  ...
  pMessage["valid"] = true;
  pMessage["seqNum"] = message.readUInt8(2);
...
// make an unregister message to unregister the servicePort
...
// make a fetch message to get all registered nodes with serviceName as a prefix
